          ...
          <a class="nav-link dropdown-toggle"  data-toggle="dropdown" id="profileDropdown">
            ...
            @if(Auth::guard('admin')->user()->type == "superadmin")
                @if(!empty(Auth::guard('admin')->user()->image))
                    <img class="" src="{{ url('admin/images/photos/'.Auth::guard('admin')->user()->image) }}">
                @else
                    <img class="" src="{{ url('admin/images/default/admin-no-image.png') }}">
                @endif
            @elseif (Auth::guard('admin')->user()->type == "vendor")
                @if(!empty(Auth::guard('admin')->user()->image))
                    <img class="" src="{{ url('admin/images/photos/'.Auth::guard('admin')->user()->image) }}">
                @else
                    <img class="" src="{{ url('admin/images/default/vendor-no-image.jfif') }}">
                @endif
            @endif
