            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                            ...
                            <form action="" name="sortProducts" id="sortProducts">
                                ...
                                <div class="toolbar-sorter">
                                    <div class="select-box-wrapper">
                                        ...
                                        <select name="sort" id="sort" class="select-box" id="sort-by">
                        ...
                        <!-- Row-of-Product-Container /- -->
                        @if(isset($_GET['sort']))
                            <div class="mt-3">{{ $categoryProducts->appends(['sort'=>$_GET['sort']])->links() }}</div>
                        @else
                            <div class="mt-3">{{ $categoryProducts->links() }}</div>
                        @endif
                        <div class="">&nbsp;</div>
                        <div class="">{{ $categoryDetails['categoryDetails']['description'] }}</div>
                    </div>
                    <!-- Shop-Right-Wrapper /- -->
