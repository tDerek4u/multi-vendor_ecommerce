            ...
            @foreach ($sliderBanners as $sliderBanner)
                <div class="bg-image">
                    <div class="slide-content">
                        <h1><a @if(!empty($sliderBanner['link'])) href="{{ url($sliderBanner['link']) }}" @else href="javascript:;" @endif><img src="{{ url('front/images/banner_images/'.$sliderBanner['image']) }}" alt="{{ $sliderBanner['alt'] }}" title="{{ $sliderBanner['title'] }}"></a></h1>
        ...
        <div class="container">
            <div class="image-banner">
                <a target="_blank" rel="nofollow" href="{{ url($fixBanners[0]['link']) }}" class="mx-auto banner-hover effect-dark-opacity">
                    <img class="img-fluid" src="{{ url('front/images/banner_images/'.$fixBanners[0]['image']) }}" alt="{{ $fixBanners[0]['alt'] }}">
                </a>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="item">
                                            <div class="image-container">
                                                <a class="item-img-wrapper-link" href="{{ url('product/'.$product['id']) }}">
                                                    ...
                                                    @else
                                                        <img class="img-fluid" src="{{ url('front/images/product_images/small/NoImage.png') }}" alt="Product">
                                                    @endif
                                                </a>
        ...
        <div class="container">
            <div class="image-banner">
                <a target="_blank" rel="nofollow" href="{{ url($fixBanners[1]['link']) }}" class="mx-auto banner-hover effect-dark-opacity">
                    <img class="img-fluid" src="{{ url('front/images/banner_images/'.$fixBanners[1]['image']) }}" alt="{{ $fixBanners[1]['alt'] }}">
                </a>
            </div>
        </div>
    </div>
