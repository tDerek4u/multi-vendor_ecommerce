            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        <a href="index.html">
                            <img src="{{ url('admin/images/logo-white.svg') }}" alt="Stack Developers"
                        ...
                        <ul class="mid-nav g-nav">
                            ...
                            @else
                                <li>
                                    <a id="mini-cart-trigger">
                                        <i class="ion ion-md-basket"></i>
                                        <span class="item-counter">{{ count($getCartItems) }}</span>
                                    </a>
                                </li>
                            @endif
    ...
    <div class="mini-cart-wrapper">
        <div class="mini-cart">
                ...
                @foreach ($getCartItems as $item)
                    ...
                    <li class="clearfix">
                        <a href="{{ url('product/' . $item['product']['id']) }}">
                            ...
                            @endif
                            <span class="mini-item-name">Normal : {{ $item['product']['product_price'] }}</span>
                            <span class="mini-item-quantity">Quantity : {{ $item['quantity'] }} </span>
                        </a>
                    </li>
                    @php
            ...
            <div class="mini-shop-total clearfix">
                ...
                <span class="mini-total-price float-right">{{ $total_price }}.MMK</span>
            </div>
